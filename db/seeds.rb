...
story1 = Story.create(title: "La premirère histoire", text: "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit...", summary: "blablabla")
